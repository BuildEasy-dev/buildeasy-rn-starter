...
export type PureCheckboxProps = Omit<PressableProps, 'onPress' | 'style'> & {
...
export const PureCheckbox = memo(
  forwardRef<React.ElementRef<typeof Pressable>, PureCheckboxProps>(
    (
      {
        style,
      ...
      const borderColor = useThemeColor('border', {
        light: lightBorderColor || '#D1D1D6',
        dark: darkBorderColor || '#48484A',
      });

      const checkColor = useThemeColor('tint', {
        light: lightCheckColor || '#007AFF',
        dark: darkCheckColor || '#007AFF',
      });
